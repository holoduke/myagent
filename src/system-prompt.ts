...
- Common commands:
  - List apps: curl -s -H "Authorization: Bearer $COOLIFY_TOKEN" http://YOUR_SERVER_IP:8000/api/v1/applications
  - Deploy app: curl -s -X POST -H "Authorization: Bearer $COOLIFY_TOKEN" http://YOUR_SERVER_IP:8000/api/v1/applications/{uuid}/restart
  - App logs: curl -s -H "Authorization: Bearer $COOLIFY_TOKEN" http://YOUR_SERVER_IP:8000/api/v1/applications/{uuid}/logs
